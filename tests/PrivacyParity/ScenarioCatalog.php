...
final class ScenarioCatalog
{
    ...
    {
        $groups = [
            'FIX-TXN-001' => ['domain' => 'transactions', 'scenario_id' => 'transaction.crud-validation', 'description' => 'CRUD validation and normalized notes', 'source' => 'TransactionController.php', 'invariants' => ['INV-TXN-001', 'INV-TXN-002', 'INV-TXN-003', 'INV-TXN-004', 'INV-TXN-005', 'INV-TXN-006', 'INV-TXN-007']],
            'FIX-TXN-002' => ['domain' => 'transactions', 'scenario_id' => 'transaction.filter-summary-pagination', 'description' => 'Filter, search, summary, and pagination', 'source' => 'TransactionController.php', 'invariants' => ['INV-TXN-008', 'INV-TXN-009', 'INV-TXN-010']],
            'FIX-TXN-003' => ['domain' => 'transactions', 'scenario_id' => 'transaction.suggestion-ranking', 'description' => 'Suggestion ranking and tie behavior', 'source' => 'TransactionController.php', 'invariants' => ['INV-TXN-011']],
            'FIX-TXN-004' => ['domain' => 'transactions', 'scenario_id' => 'transaction.duplicate-import-linkage', 'description' => 'Duplicate fingerprint and import linkage', 'source' => 'CsvImportCommitter.php', 'invariants' => ['INV-TXN-012']],
            'FIX-TXN-005' => ['domain' => 'transactions', 'scenario_id' => 'transaction.fund-linked-mutation', 'description' => 'Fund-linked transaction mutation', 'source' => 'FundTransactionIntegrationService.php', 'invariants' => ['INV-TXN-013']],
            'FIX-TAX-001' => ['domain' => 'taxonomy', 'scenario_id' => 'taxonomy.lifecycle-and-icons', 'description' => 'Uniqueness, reactivation, favorites, and icons', 'source' => 'TaxonomyController.php', 'invariants' => ['INV-TAX-001', 'INV-TAX-002', 'INV-TAX-003', 'INV-TAX-005'], 'scenario_variants' => [['scenario_id' => 'taxonomy.historical-relationships-after-delete', 'description' => 'Historical transaction relationships survive taxonomy deletion', 'invariants' => ['INV-TAX-007']]]],
            'FIX-BUD-001' => ['domain' => 'budgets', 'scenario_id' => 'budget.allocation-validation', 'description' => 'Percent and amount allocation validation', 'source' => 'BudgetSettingsResolver.php', 'invariants' => ['INV-BUDGET-001', 'INV-BUDGET-002']],
            'FIX-BUD-002' => ['domain' => 'budgets', 'scenario_id' => 'budget.income-conversion', 'description' => 'Income breakdown and hourly conversion', 'source' => 'BudgetSettingsResolver.php', 'invariants' => ['INV-BUDGET-003', 'INV-BUDGET-004']],
            'FIX-BUD-003' => ['domain' => 'budgets', 'scenario_id' => 'budget.effective-month-inheritance', 'description' => 'Effective-month inheritance and history', 'source' => 'BudgetSettingsResolver.php', 'invariants' => ['INV-BUDGET-005', 'INV-BUDGET-006', 'INV-BUDGET-008']],
            'FIX-REC-001' => ['domain' => 'recurring', 'scenario_id' => 'recurring.schedule-generation', 'description' => 'Schedule and date generation', 'source' => 'RecurringExpenseService.php', 'invariants' => ['INV-REC-002', 'INV-REC-003', 'INV-REC-004', 'INV-REC-006']],
            'FIX-REC-002' => ['domain' => 'recurring', 'scenario_id' => 'recurring.version-change-delete', 'description' => 'Version overlap, change, and delete', 'source' => 'RecurringExpenseService.php', 'invariants' => ['INV-REC-001', 'INV-REC-008', 'INV-REC-009']],
            'FIX-REC-003' => ['domain' => 'recurring', 'scenario_id' => 'recurring.idempotent-materialization', 'description' => 'Idempotent occurrence materialization', 'source' => 'RecurringExpenseService.php', 'invariants' => ['INV-TXN-014', 'INV-REC-005', 'INV-REC-010']],
            'FIX-OVR-001' => ['domain' => 'overview', 'scenario_id' => 'overview.month-summary', 'description' => 'Month overview totals and progress', 'source' => 'MonthOverviewService.php', 'invariants' => ['INV-OVR-001', 'INV-OVR-002', 'INV-OVR-003']],
            'FIX-OVR-002' => ['domain' => 'insights', 'scenario_id' => 'insights.range-aggregates', 'description' => 'Insights ranges, rankings, and distributions', 'source' => 'MetricsController.php', 'invariants' => ['INV-OVR-004', 'INV-OVR-005']],
            'FIX-FUND-001' => ['domain' => 'funds', 'scenario_id' => 'fund.ledger-balance-goal', 'description' => 'Ledger balance and goal state', 'source' => 'FundBalanceService.php', 'invariants' => ['INV-FUND-001', 'INV-FUND-002', 'INV-FUND-003', 'INV-FUND-004', 'INV-FUND-005']],
            'FIX-FUND-002' => ['domain' => 'funds', 'scenario_id' => 'fund.archive-source-restrictions', 'description' => 'Archived and source restrictions', 'source' => 'FundService.php', 'invariants' => ['INV-FUND-006', 'INV-FUND-007', 'INV-FUND-008']],
            'FIX-FUND-003' => ['domain' => 'funds', 'scenario_id' => 'fund.transaction-closeout-linkage', 'description' => 'Transaction and closeout linkage', 'source' => 'FundCloseoutIntegrationService.php', 'invariants' => ['INV-FUND-009', 'INV-FUND-010', 'INV-FUND-011', 'INV-FUND-013']],
            'FIX-SAV-001' => ['domain' => 'savings-plan', 'scenario_id' => 'savings-plan.allocation-state', 'description' => 'Plan, no-plan, and over-allocation state', 'source' => 'SavingsPlanService.php', 'invariants' => ['INV-SAVINGS-001', 'INV-SAVINGS-002', 'INV-SAVINGS-003', 'INV-SAVINGS-004']],
            'FIX-SAV-002' => ['domain' => 'savings-plan', 'scenario_id' => 'savings-plan.pacing-directed-activity', 'description' => 'Directed, unplanned, and pacing behavior', 'source' => 'SavingsPlanService.php', 'invariants' => ['INV-SAVINGS-005', 'INV-SAVINGS-007', 'INV-SAVINGS-008']],
            'FIX-CLOSE-001' => ['domain' => 'closeouts', 'scenario_id' => 'closeout.eligibility-result-snapshot', 'description' => 'Eligibility, result, and snapshot', 'source' => 'MonthCloseoutService.php', 'invariants' => ['INV-CLOSEOUT-001', 'INV-CLOSEOUT-002', 'INV-CLOSEOUT-003', 'INV-CLOSEOUT-004', 'INV-CLOSEOUT-005', 'INV-CLOSEOUT-006']],
            'FIX-CLOSE-002' => ['domain' => 'closeouts', 'scenario_id' => 'closeout.allocation-reopen-stale', 'description' => 'Allocation, reopen, and stale behavior', 'source' => 'MonthCloseoutService.php', 'invariants' => ['INV-CLOSEOUT-007', 'INV-CLOSEOUT-008', 'INV-CLOSEOUT-009', 'INV-CLOSEOUT-010', 'INV-CLOSEOUT-011', 'INV-CLOSEOUT-012']],
            'FIX-CSV-001' => ['domain' => 'csv', 'scenario_id' => 'csv.preview-dry-run-mappings', 'description' => 'Preview, dry-run, and mappings', 'source' => 'CsvImportService.php', 'invariants' => ['INV-CSV-001', 'INV-CSV-002', 'INV-CSV-003', 'INV-CSV-004', 'INV-CSV-005', 'INV-CSV-006', 'INV-CSV-007', 'INV-CSV-008', 'INV-CSV-009', 'INV-CSV-010']],
            'FIX-CSV-002' => ['domain' => 'csv', 'scenario_id' => 'csv.commit-rollback-export', 'description' => 'Commit, duplicates, rollback, and export', 'source' => 'CsvExportService.php', 'invariants' => ['INV-CSV-011', 'INV-CSV-012']],
            'FIX-CROSS-001' => ['domain' => 'cross-domain', 'scenario_id' => 'cross.transaction-fund-closeout', 'description' => 'Transaction to Fund to closeout lifecycle', 'source' => 'FundCloseoutIntegrationService.php', 'invariants' => []],
        ];
