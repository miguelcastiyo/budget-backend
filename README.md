...
- Context payloads/responses include an optional context-only `icon_key` (`null` allowed). Context icon keys are separate from tag icon keys and use name-based fallback when omitted.
